...
> 更多参数用法：https://docs.djangoproject.com/zh-hans/3.1/ref/models/fields/#filefield
{.is-info}
...
通过设置该字段，当使用 ModelForm 或管理中渲染该字段时加以限制。
...
导致 ModelForm 上的对应字段只列出有 `is_staff=True` 的 Users
